...
for j in range(len(times)):
    ...
    #sns.heatmap(P_mat.T)
    plt.title(f"Probability function at t = {time_title[j]}",fontsize=fontsize)
    cb = plt.colorbar()
    ...
    plt.title(f"Real part of the wave function at t = {time_title[j]}",fontsize=fontsize)
    cb = plt.colorbar()
    ...
    plt.title(f"Imaginary part of the wave function at t = {time_title[j]}",fontsize=fontsize)
    cb = plt.colorbar()
