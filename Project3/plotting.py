...
def main():
    ...
    #plt.plot(x, y, label="Two particles, x1 against y1, with particle interaction")
    ...
    # x against v_x
    #plt.plot(x[:,0], v_x[:,0],"g", label="x against v_x, particle1") # Particle 1
    #plt.plot(x[:,1], v_x[:,1], "b", label="x against v_x, particle2") # Particle 2
    #plt.xticks(size=ticksize)
    #plt.yticks(size=ticksize)
    #plt.legend()
    #plt.show()
